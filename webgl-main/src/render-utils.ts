...
function CompileShader(gl: WebGLRenderingContext, shaderSrc: string, shaderType: number) : WebGLShader | null {
...
function CreateMaterial(gl: WebGLRenderingContext, vertexShaderSrc: string, fragmentShaderSrc: string) : WebGLProgram | null {
    ...
    if (!vertexShader || !fragmentShader) {
        console.error("Failed to compile vertex or fragment shader inside the CreateMaterial function...");
        return null;
    }
